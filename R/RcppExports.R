...
euler_multi_particles_with_weights <- function(x0s, weight_init, t0, r, dt, n, dW, modeltime, modelstate, observed_drift, unobserved_drift, observed_diffusion, unobserved_diffusion, deltaY, env, rho) {
    .Call('_yuima_euler_multi_particles_with_weights', PACKAGE = 'yuima', x0s, weight_init, t0, r, dt, n, dW, modeltime, modelstate, observed_drift, unobserved_drift, observed_diffusion, unobserved_diffusion, deltaY, env, rho)
}
