...
euler_multi_particles_with_weights <- function(x0s, t0, r, dt, n, dW, modeltime, modelstate, drift, diffusion, env, rho) {
    .Call('_yuima_euler_multi_particles_with_weights', PACKAGE = 'yuima', x0s, t0, r, dt, n, dW, modeltime, modelstate, drift, diffusion, env, rho)
}
