...
extern SEXP _yuima_euler_multi_particles_with_weights(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_yuima_euler_multi_particles_with_weights",     (DL_FUNC) &_yuima_euler_multi_particles_with_weights,           12},
    {NULL, NULL, 0}
};
